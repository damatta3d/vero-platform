...
Os ADR-001 a ADR-008 estão aprovados e integrados à `main`. O ADR-009 está em estado `Proposed` na branch `agent/core-access-foundation`; sua implementação permanece bloqueada até revisão e aprovação explícita do Arquiteto-Chefe.
