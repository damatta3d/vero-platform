...
<body>
  ...
  <main>
    ...
    <section class="modules">
      <a href="/operacao" class="module"><small>ROTINA DIÁRIA</small><h2>Operação</h2><p>Receitas, despesas, pedidos, canais e fechamento operacional.</p><span>Acessar →</span></a>
      <a href="/manager" class="module"><small>PEDIDOS E CARDÁPIO</small><h2>VERO Manager</h2><p>Fila da cozinha, detalhes dos pedidos, cardápio e configurações da loja.</p><span>Acessar →</span></a>
...
*{box-sizing:border-box}body{margin:0;background:var(--paper);color:var(--ink);font-family:Inter,Arial,sans-serif}header{height:72px;background:#211d19;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:0 max(24px,calc((100% - 1080px)/2))}header div{display:flex;gap:14px;align-items:baseline}header strong{font:700 28px Georgia,serif;letter-spacing:.12em}header span{color:#cfc4b9}main{max-width:1080px;margin:28px auto;padding:0 22px}.card,.module{background:var(--card);border:1px solid var(--line);border-radius:16px;box-shadow:0 6px 24px #45351f0c}.hero{padding:28px;display:flex;justify-content:space-between;gap:24px;align-items:center}.hero h1{font:700 38px Georgia,serif;margin:6px 0}.hero p{margin:0;color:var(--muted)}small{color:var(--red);font-weight:800;letter-spacing:.1em}.status{padding:12px 16px;border-radius:999px;font-weight:700}.status.ok{background:#e5f1e9;color:var(--green)}.status.error{background:#f7e4e1;color:var(--red)}.status.pending{background:#eee8df;color:var(--muted)}.access{padding:24px;margin:18px 0}.access h2{margin-top:0}.grid{display:grid;grid-template-columns:2fr 1fr auto;gap:14px;align-items:end}label{font-size:13px;font-weight:700}input,button{width:100%;min-height:44px;margin-top:7px;border:1px solid var(--line);border-radius:9px;padding:10px 12px;font:inherit}button{background:var(--red);border:0;color:#fff;font-weight:800;cursor:pointer}.secondary{width:auto;background:transparent;border:1px solid #6e6258;margin:0}.message{color:var(--muted);margin-bottom:0}.message.ok{color:var(--green)}.message.error{color:var(--red)}.modules{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.module{display:block;padding:24px;text-decoration:none;color:inherit;transition:.15s}.module:hover{transform:translateY(-2px);border-color:#bba99a}.module h2{font:700 24px Georgia,serif;margin:8px 0}.module p{color:var(--muted);min-height:66px}.module span{color:var(--red);font-weight:800}@media(max-width:760px){.hero{align-items:flex-start;flex-direction:column}.grid,.modules{grid-template-columns:1fr}.module p{min-height:auto}header span{display:none}}
`;
