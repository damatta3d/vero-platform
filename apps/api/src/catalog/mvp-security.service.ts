        ...
        evaluate: (request) =>
          Promise.resolve({
            outcome:
              ...
              (request.action.value.startsWith('coupons.') &&
                request.resource.value === 'coupons.management') ||
              (request.action.value.startsWith('delivery.') &&
                request.resource.value === 'delivery.management')
                ? 'allow'
                : 'deny',
