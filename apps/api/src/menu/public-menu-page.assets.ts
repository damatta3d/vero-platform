...
.pix-payment{margin:18px 0;padding:16px;border-radius:12px;background:#f8f3ed}.pix-payment img{display:block;width:min(280px,100%);margin:14px auto}.pix-code{font-family:monospace}.pix-payment.paid{background:#edf7f0;color:#214f34}
